...
1. Push this repo to GitHub and tag a release: `git tag v0.4.0 && git push --tags`.
2. Compute the tarball checksum:
   `curl -sL https://github.com/briandaviddavidson/dashlane-auditor/archive/refs/tags/v0.4.0.tar.gz | shasum -a 256`
